            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="products_edit.php">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
     <input type="text" class="form-control" id="edit_name" name="name" value="<?php echo $products['name']; ?>" >
                  </div>
               <div class="pull-left info">
        <p><b>Shopname: </b><?php echo $seller['shopname']; ?></p>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="edit_price" name="price" value="<?php echo $products['price']; ?>">
                  </div>
                </div>
                <p><b>Description</b></p>
                <div class="form-group">
