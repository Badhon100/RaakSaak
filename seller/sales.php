                    ...
                    try{
                      ...
                      foreach($stmt as $row){
                        ...
                        foreach($stmt as $details){
                          ...
                          $total += $subtotal;
                          $percentage = $total * 0.01;
                          $remain = $total - $percentage;
                        ...
                        echo "
                          ...
                          <tr>
                            ...
                            <td>TK. ".number_format($remain, 2)."</td>
                            <td>TK. ".number_format($percentage, 2)."</td>
              ...
              <div class='col-sm-3'>
	       								<div class='box box-solid'>
		       								<div class='box-body prod-body'>
		       									...
		       									<h4><b>Total Sells Amount: TK. <?php echo $amount; ?> </b></h4>
		       								</div>
